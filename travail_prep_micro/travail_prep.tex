...
Les résultats de l'analyse ont entrainés les choix suivants: une magnification de 60, une ouverture numérique de 0.85, une longueur focale pour la lentille tube
...
\end{equation}
Il est possidle de tracer une régression linéaire, où l'incertitude sur la valeur de la pente est donnée par l'équation (\ref{deltad}).
...
la magnification et l'ouverture numérique de l'objectif, la longueur focale la lentille tube, la taille de la particule ainsi que le 
